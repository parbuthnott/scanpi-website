            ...
            if (file_exists($rootshellplayerdir."/queue")) {
               ...
               if ($hassome != '0') {
                  ...
                  foreach ($files as $queueitem) {
                     ...
                     echo "<li><a class='queuelink' href=\"queue.php?queueaction=remove&amp;queueitem=".$queueitem."\" title=\"remove item from queue\">x</a>\n";
                     if ($prevqueueitem != '0') {
                        echo "<a class='queuelink' href=\"queue.php?queueaction=switch&amp;from=".$queueitem."&amp;to=".$prevqueueitem."\" title=\"move up the queue\">&uarr;</a>\n";
//                      echo "<a class='queuelink' href=\"queue.php?queueaction=switch&amp;to=".$queueitem."&amp;from=".$prevqueueitem."\" title=\"move down the queue\">&darr;</a>\n";
                     }
//                   echo "(".$queueitem.")";
            ...
            if (file_exists($rootshellplayerdir."/played")) {
               ...
               if ($hassome != '0') {
                  ...
                  foreach ($files as $queueitem) {
                     ...
                     $detailsarray = explode("/", $filedetails);
                     echo "<li><a class='queuelink' href=\"queue.php?queueaction=requeue&amp;queueitem=".$queueitem."\" title=\"requeue item\">+</a>";
//                   echo "(".$queueitem.")";
                     echo " ".$detailsarray[4]." : ".$detailsarray[5]." : ".$detailsarray[6]."</li>\n";
                  }
                  echo "</ul></div>\n";
